...
<link rel="SHORTCUT ICON" href="/favicon.ico?202311281400">
    ...
    <link rel="canonical" href="https://www.jobkorea.co.kr/help/inquiry/list">
    <link rel="alternate" href="https://m.jobkorea.co.kr/help/inquiry/list" media="only screen and (max-width: 640px)">
    <link rel="alternate" href="ios-app://569092652/https/m.jobkorea.co.kr/help/inquiry/list">
    <link rel="alternate" href="android-app://com.jobkorea.app/https/m.jobkorea.co.kr/help/inquiry/list">
...
<meta property="og:url" content="https://www.jobkorea.co.kr/help/inquiry/list">
				...
				<div class="loungeContent inquiryContent">
					...
					<div class="inquiryViewWrap">
						<div class="inquiryView">
							<div class="viewCont">
								<dl class="inqCont">
									<dt><strong>[제안/문의]</strong><c:out value="${ qnaDetail.i_DATE }" /></dt>
									<dd><c:out value="${ qnaDetail.i_CONTENT }" /></dd>
								</dl>
							</div>
							<c:if test="${ qnaDetail.i_REPLY_CONDITION eq 'Y' }" >
							<div class="viewCont">
								<dl class="inqCont">
									<dt><strong>[답변]</strong><c:out value="${ qnaDetail.i_REPLY_DATE }" /></dt>
									<dd><c:out value="${ qnaDetail.i_REPLY }" /></dd>
								</dl>
							</div>
							</c:if>
						</div>
						...
						<div class="listBtmArea">
							<div class="btnListExDn">
								<a href="/help/inquiry/list" class="btnMtcTpl">목록</a>
							</div>
...
<div id="criteo-tags-div" style="display: none;"></div><iframe allow="join-ad-interest-group" data-tagging-id="G-GQWHSF87P4" data-load-time="1701260197701" height="0" width="0" style="display: none; visibility: hidden;" src="https://td.doubleclick.net/td/ga/rul?tid=G-GQWHSF87P4&amp;gacid=1472197204.1699592836&amp;gtm=45je3b81v890431961z8855351470&amp;dma=0&amp;gcd=11l1l1l1l1&amp;aip=1&amp;fledge=1&amp;z=1652655112"></iframe><div id="criteo-tags-div" style="display: none;"></div><div id="criteo-tags-div" style="display: none;"></div></body></html>