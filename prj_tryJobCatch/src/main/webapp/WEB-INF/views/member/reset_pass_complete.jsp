...
<div id="header">
	<div class="gnbWrap gnbWrap_mSearch">
		...
		<div id="gnb">
			...
			<div class="secNav">
				<ol>
					<li class="mn1"><a href="http://211.63.89.133/prj_tryJobCatch/member/searchIdFrm.do"><span style="
    background-position: 0 -54px;
"></span>아이디 찾기</a></li>
					<li class="mn2"><a href="http://211.63.89.133/prj_tryJobCatch/member/searchPassFrm.do"><span style="
...
비밀번호가 변경되었습니다.						
				...
				<p class="mbrBtnFunc"><span class="mbrBtn mbrBtnLogin_1"><a href="http://211.63.89.133/prj_tryJobCatch/member/loginFrm.do">로그인</a></span> </p>
			</div>
