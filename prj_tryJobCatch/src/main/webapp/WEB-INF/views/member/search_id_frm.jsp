		...
		<div id="content">
			...
			<div class="mbrSec mbrSch mbrSchID">
				...
				<div class="mbrTplDesc">
					<p>해당하는 회원을 선택 후 가입 시 입력한 본인정보를 입력해 주세요.</p>
				</div>
				<form name="pageForm" method="post" id="searchIdFrm" action="http://211.63.89.133/prj_tryJobCatch/member/searchId.do">
				...
				<legend>개인회원-이메일인증 입력폼</legend>	
					<div class="mbrTplBox" id="mbrSearchBox">
						...
						<ul class="mbrTplData1" id="coSearchData">
							<li>
								<div class="option">
									
								</div>
							</li>
							<li id="devName"><label for="lb_name" class="title">이름</label> <input type="text" name="M_NAME" id="lb_name" maxlength="12" style="ime-mode:active;width:308px;" class="ipText" ></li>
							<li id="devEmailForm" style="display: list-item;">
						...
						<ul class="mbrTplData1">
							...
							<li>
								<label for="C_Register" class="title">
									가입자명
									<div class="tipHover">
										<button><img src="https://i.jobkorea.kr/content/images/2023/member/icoLoginTip.png" alt="기업회원"></button>
										<div class="tip">
			...
			<p class="mbrBtnFunc"><span class="mbrBtn mbrBtnSearch_4"><button type="button" id="searchIdBtn"><span>아이디찾기</span></button></span></p>
