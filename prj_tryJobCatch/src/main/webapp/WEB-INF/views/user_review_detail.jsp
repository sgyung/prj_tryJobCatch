...
<html lang="ko"><head>
    <!-- Meta Info -->
            <title>기업리뷰 - 경험자의 생생한 근무 후기 | TryJobCatch</title>


<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">

<link rel="SHORTCUT ICON" href="/favicon.ico?202312111400">
...
<link href="//i.jobkorea.kr/content/css/ver_2/common-sv-202311301113.css" rel="stylesheet" type="text/css"><link href="//i.jobkorea.kr/deploy/pc/dist/css/personal/common/gnb-sv-202311301113.css" rel="stylesheet" type="text/css">
    ...
    <link href="//i.jobkorea.kr/deploy/pc/dist/css/personal/pages/review/review_view-sv-202306231251.css" rel="stylesheet" type="text/css">
...
function deleteLike(id) {
    var confirmationMessage = "관심기업을 삭제하시겠습니까?";
...
<body id="secMtu" cz-shortcut-listen="true" style="">
...
<script type="text/javascript" src="/Scripts/User/Mict.js?202312111400"></script>
...
<script src="//i.jobkorea.kr/content/js/sidebar.min-sv-202005061649.js" type="text/javascript"></script>        <script>
    ...
    <div id="wrap">
        ...
        <!--신입공채 LNB 개편-->
        <div id="container">
                <input type="hidden" id="MemTypeCode" value="M">
                <input type="hidden" id="UcoNo1" value="1808526">
                <input type="hidden" id="UcoNo2" value="0">
                <input type="hidden" id="CName1" value="에스케이핀크스㈜">
...
<h1 class="skip">기업리뷰 리뷰보기</h1>
<div class="content">
    <!-- not-data 클래스 > 리뷰보기 데이터 없음 안내문구 생성 + 차트 블러 처리 + 더 자세히 알아봐요 , 채용중 세션 display none -->
    <div class="cont-wrap">
        <!-- 리뷰보기 -->
        <h3 class="sec01-tit">리뷰보기</h3>
        <section class="section section01">
            <div class="result-list_left co">
                ...
                <div class="co-info">
                    <div class="co-hd">
                        <span class="co-name"><c:out value="${ requestScope.co_name }"/></span>
                            <span class="recruit"></span>
                    </div>
                    <div class="co-detail">
                    <c:out value="${ requestScope.industry }"/>
                   </div>
                        <a href="/Recruit/Co_Read/C/103716" target="_blank">기업 정보 보기</a>
                </div>
            </div>
            <div class="result-list_right">
                <a href="http://localhost/prj_tryJobCatch/writeReview.do">리뷰쓰기</a>
                    ...
                    <c:if test="${requestScope.likeState eq 'Y'}">
					    ...
					    <label for="like">관심기업</label>
					</c:if>
					<c:if test="${requestScope.likeState eq null}">
					    <input type="checkbox" name="like" id="like" onclick="addLike()" data-memsysno="103716">
					    <label for="like">관심기업</label>
					</c:if>
                    </div>
            </div>
        ...
        <!-- section02에 id="not-login" 추가 시 : '리뷰를 작성하면 공개 됩니다' 안내 문구 & 블러처리 -->
        <section class="section section02" id="section02">
            <div class="chart-wrap">
                <div class="chart-wrap-top">
                    <!-- 추천 지수 -->
                    <div class="chart">
                        <div class="chart-content">
                            <div class="chart-hd main">
                                <h4 class="tip">리뷰 총평</h4>
                                <div class="box-point">
                                    <div class="point clearfix">
                                            <button class="star-point left first "></button>
                                            <button class="star-point right  "></button>
                                            <button class="star-point left  "></button>
                                            <button class="star-point right  "></button>
                                            <button class="star-point left  "></button>
                                            <button class="star-point right  "></button>
                                            <button class="star-point left  "></button>
                                    ...
                                    <div class="text-point">0</div>
                                </div>
                                <div class="toolTip">
                                    <p>■ 그래프 : 급여/워라밸/복리후생/고용안정성(사업성)/커리어 성장/조직문화 각 카테고리별 5점 만점 측정 점수를 100점 만점으로 환산하여 평균을 낸 점수입니다. </p>
                                    <button class="close"></button>
                                </div>
                            </div>
                            <div class="chart-main">
 								<dl class="chart-data-text pay">    
									<dt>급여</dt>    
									<dd><c:out value="${ requestScope.totalSalary }"/></dd>
 								</dl>
 								<dl class="chart-data-text balance">    
	 								<dt>워라밸</dt>    
	 								<dd><c:out value="${ requestScope.totalBalance }"/></dd>
 								</dl> <dl class="chart-data-text culture">    
	 								<dt>조직문화</dt>    
	 								<dd><c:out value="${ requestScope.totalCulture }"/></dd>
 								</dl> 
 								<dl class="chart-data-text benefit">    
	 								<dt>복리후생</dt>    
	 								<dd><c:out value="${ requestScope.totalWelfare }"/></dd> 
 								</dl> <dl class="chart-data-text stability">    
	 								<dt>고용안정성</dt>    
	 								<dd><c:out value="${ requestScope.totalStability }"/></dd> 
 								</dl> 
	 								<dl class="chart-data-text growth">    
	 								<dt>커리어성장</dt>    
 								<dd><c:out value="${ requestScope.totalCareer }"/></dd> 
 								</dl>
                                <div class="chart-wrap">
                                    <canvas id="totalChart" height="200" width="300" style="display: block; box-sizing: border-box; height: 200px; width: 300px;"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="chart">
                        <div class="chart-content">
                            <div class="chart-hd like">
                                <h4 class="tip">이런 점이 좋았어요.</h4>
                                <div class="toolTip">
                                    <p>전·현직자가 선택한 이 회사의 장점 키워드 TOP 순위입니다. </p>
                                    <button class="close"></button>
                                </div>
                            </div>
        ...
        <!-- 이 기업은 채용중 10건 -->
            <div class="heading">
                <h3>이 기업은 채용중 <span class="blue"><c:out value="${ requestScope.recruitmentCnt }"/></span>건</h3>
            </div>
...
<!-- // 모달창 -->    </div>
    ...
    <ins class="adsbygoogle adsbygoogle-noablate" data-adsbygoogle-status="done" style="display: none !important;" data-ad-status="unfilled"><div id="aswift_0_host" tabindex="0" title="Advertisement" aria-label="Advertisement" style="border: none; height: 0px; width: 0px; margin: 0px; padding: 0px; position: relative; visibility: visible; background-color: transparent; display: inline-block;"><iframe id="aswift_0" name="aswift_0" browsingtopics="true" style="left:0;position:absolute;top:0;border:0;width:undefinedpx;height:undefinedpx;" sandbox="allow-forms allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation-by-user-activation" frameborder="0" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" scrolling="no" allow="attribution-reporting" src="https://googleads.g.doubleclick.net/pagead/ads?client=ca-pub-2252464458280030&amp;output=html&amp;adk=1606527269&amp;adf=2080654236&amp;lmt=1702297636&amp;plat=9%3A32776%2C16%3A8388608%2C17%3A32%2C24%3A32%2C25%3A32%2C30%3A1081344%2C32%3A32%2C41%3A32%2C42%3A32&amp;plas=308x630_l%7C222x630_r&amp;format=0x0&amp;url=https%3A%2F%2Fwww.jobkorea.co.kr%2FReview%2FServiceView%3FucoNo%3D1808526&amp;ea=0&amp;pra=5&amp;wgl=1&amp;easpi=1&amp;asro=0&amp;asiscm=1&amp;aslmt=0.4&amp;asamt=-1&amp;asedf=0&amp;asefa=1&amp;aseiel=1~2~4~6&amp;uach=WyJXaW5kb3dzIiwiMTAuMC4wIiwieDg2IiwiIiwiMTIwLjAuNjA5OS43MSIsbnVsbCwwLG51bGwsIjY0IixbWyJOb3RfQSBCcmFuZCIsIjguMC4wLjAiXSxbIkNocm9taXVtIiwiMTIwLjAuNjA5OS43MSJdLFsiR29vZ2xlIENocm9tZSIsIjEyMC4wLjYwOTkuNzEiXV0sMF0.&amp;dt=1702297636279&amp;bpp=2&amp;bdt=316&amp;idt=217&amp;shv=r20231206&amp;mjsv=m202312050101&amp;ptt=9&amp;saldr=aa&amp;abxe=1&amp;cookie=ID%3De694e610696ceeca-221d80e981e500fb%3AT%3D1699510675%3ART%3D1699510675%3AS%3DALNI_MY81yHlHaGxhuI2sZjVA-DymgEphQ&amp;gpic=UID%3D00000c82aa33f39c%3AT%3D1699510675%3ART%3D1699510675%3AS%3DALNI_MaNK6ufgCCHFtFiLUh6dkAzOYyasA&amp;nras=1&amp;correlator=5284800366238&amp;frm=20&amp;pv=2&amp;ga_vid=1907109562.1701626643&amp;ga_sid=1702297637&amp;ga_hid=251496899&amp;ga_fc=1&amp;u_tz=540&amp;u_his=4&amp;u_h=1080&amp;u_w=1920&amp;u_ah=1040&amp;u_aw=1920&amp;u_cd=24&amp;u_sd=1&amp;dmc=8&amp;adx=-12245933&amp;ady=-12245933&amp;biw=1903&amp;bih=931&amp;scr_x=0&amp;scr_y=0&amp;eid=44759876%2C44759927%2C44759837%2C31079920%2C31079979%2C42531644%2C44795922%2C95320869%2C95320884%2C31078663%2C31078665%2C31078668%2C31078670&amp;oid=2&amp;pvsid=1348727378629300&amp;tmod=1280941929&amp;uas=0&amp;nvt=1&amp;fsapi=1&amp;ref=https%3A%2F%2Fwww.jobkorea.co.kr%2FReview%2FHome&amp;fc=1920&amp;brdim=0%2C0%2C0%2C0%2C1920%2C0%2C1920%2C1040%2C1920%2C931&amp;vis=1&amp;rsz=%7C%7Cs%7C&amp;abl=NS&amp;fu=32768&amp;bc=31&amp;td=1&amp;psd=W251bGwsbnVsbCwicHJlcGVyaW9kIiwxXQ..&amp;nt=1&amp;ifi=1&amp;uci=a!1&amp;fsb=1&amp;dtd=240" data-google-container-id="a!1" data-load-complete="true"></iframe></div></ins><script src="/resources/js/common/dist/jk.common.min.js?ver=202312111400"></script>
    <script src="/resources/js/user/dist/jk.user.review.js?ver=202312111400"></script>

    <script type="text/javascript">
        var rsWindowManager = jk.user.review.reviewDefault;
        rsWindowManager.load("body");
    </script>

    <script src="//i.jobkorea.kr/deploy/pc/dist/js/review/ui.user.review.common-sv-202303081532.js" type="text/javascript"></script>

    
    <script type="text/javascript" src="/Scripts/Common/ServiceFunction.js?v=202312111400"></script>

    <script type="text/javascript">
        // 조회한 공고 음영처리
        $('.contArea dl').click(function () {
            $(this).addClass('read');
        });
        $('.now-contents .swiper-slide').click(function () {
            $(this).addClass('read');
        });
        $('.recruit-left a').click(function () {
            $(this).parents('.recruit-list').addClass('read');
        });

        var avgSalaryAmt = 52020000;
        var subSalary1 = 0;
        var subSalary2 = 0;
        var mainStarterAvgSalaryAmt = 33300000;
        var mainExecutiveAvgSalaryAmt = 0;
        var ChartSalaryRangeText = [''];

        $(document).ready(function () {
            jk.user.review.serviceview.load();
            $("#keywordEgCnt").text(0);

            $(".button-share").on("click", function () {
                $(".layer-share").toggleClass("hidden");
            });
        });

        function openSalary(ucoNo, memSysNo) {
            if (memSysNo > 0) {
                window.open("/Recruit/Salary/" + memSysNo);
            }
            else {
                window.open("/company/" + ucoNo + "/salary");
            }
        }

        //Chart function
        var crvDisplayStat = Number("1");
        var crvDataStat = Number("1");
        totalChartDraw(["${totalSalary}", "${totalBalance}","${totalStability}","${totalCulture}","${totalCareer}", "${totalWelfare}" ]); //연봉,워라벨,조직문화,복지,고용안정성,커리어총평 차트

        if (crvDataStat == 0 || crvDisplayStat == 0) {
            annualLeaveChartDraw([50, 25, 15, 10]); //연차 휴가 차트

            circleChartDraw('bonusChart', 0.50); //성과급
            circleChartDraw('bonusRatioChart', 0.50); //성과급
            circleChartDraw('overtimeChart', 0.65); //초과근무
            circleChartDraw('benefitChart', 0.65); //복지제도
            circleChartDraw('diningChart', 0.65); //회식
            circleChartDraw('mentorChart', 0.65); //도움받을 사람
            circleChartDraw('expectationChart', 0.65); //승진 중요 요소
            circleChartDraw('concurrentlyChart', 0.65); //기대한, 다른 업무 병행
        }
        else {
            //totalChartDraw([50, 50, 75, 50, 75, 50]); //총평 차트
            annualLeaveChartDraw([100, 0, 0, 0]); //연차 휴가 차트

            var avgTotal1 = chartNumConvert("100");
            var avgTotal2 = chartNumConvert("100");
            var avgTotal4 = chartNumConvert("100");
            var avgTotal10 = chartNumConvert("100");
            var avgTotal10_content = "부서별로 차이가 있어요.";
            var avgTotal6 = chartNumConvert("100");
            var avgTotal7 = chartNumConvert("100");
            var avgTotal14 = chartNumConvert("100");
            var avgTotal15 = chartNumConvert("100");


            
                circleChartDraw('bonusChart', avgTotal1); //성과급
                circleChartDraw('bonusRatioChart', avgTotal2); //성과급
                circleChartDraw('overtimeChart', avgTotal4); //초과근무
                if ($.trim(avgTotal10_content) != "") {
                    circleChartDraw('benefitChart', avgTotal10); //복지제도
                }
                circleChartDraw('diningChart', avgTotal6); //회식
                circleChartDraw('mentorChart', avgTotal7); //도움받을 사람
                circleChartDraw('expectationChart', avgTotal14); //승진 중요 요소
                circleChartDraw('concurrentlyChart', avgTotal15); //기대한, 다른 업무 병행
            
        }

        function chartNumConvert(data) {
            var ret = 0;
            var num = Number(data);
        ...
        function changeAmt(no) {
            $(".amtInfo").css("display", "none");
            $("#amtInfo" + no).css("display", "block");
        }
...
<iframe width="1" height="1" scrolling="no" frameborder="0" style="display:none" src="https://asia.creativecdn.com/ig-membership?ntk=1Im9Xsc_dLayGLf_2i7_bi7-lp-2dSBpJ6z0GBBPb0DN0rfAEO_xQZQ5EkIL7FcAGHdIlA6nSKofCvyl6ER-HtuqKOcADUROfh69ao-RZgs"></iframe><iframe width="1" height="1" scrolling="no" frameborder="0" style="display:none" src="https://asia.creativecdn.com/topics-membership?ntk=IBdCUifHOsQ4JfSptcCwIMBSAM5PC_v7OEJJRS3BqgnQMCyQIzTsHse9XCK_9Gju1HZPcTfwyNAafbEOPYbWdw"></iframe><div id="criteo-tags-div" style="display: none;"></div><iframe src="https://www.google.com/recaptcha/api2/aframe" width="0" height="0" style="display: none;"></iframe></body><iframe id="google_esf" name="google_esf" src="https://googleads.g.doubleclick.net/pagead/html/r20231206/r20190131/zrt_lookup_fy2021.html" style="display: none;"></iframe></html>