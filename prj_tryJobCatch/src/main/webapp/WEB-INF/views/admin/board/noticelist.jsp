...
<script type="text/javascript">
	$(function() {
		$("#btn").click(function() {
			location.href = "http://211.63.89.133/prj_tryJobCatch/notice_modify_frm.do"
		});
	...
	<div class="wrapper">
	  ...
	  <aside class="main-sidebar sidebar-dark-primary elevation-4">
		...
		<div class="content-wrapper" >
			...
			<!-- /.content-header -->
	<form action="http://211.63.89.133/prj_tryJobCatch/noticeinfo.do" method="post" id="goInfo">
