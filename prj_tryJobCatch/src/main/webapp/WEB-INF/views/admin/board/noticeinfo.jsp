...
$(function() {
	$("#list").click(function() {
		location.href = "http://211.63.89.133/prj_tryJobCatch/noticelist.do"
	});
...
<%-- 			<table class="table"
      ...
      <td>y</td>
			...
			<form action="http://211.63.89.133/prj_tryJobCatch/notice_modify_frm.do" method="post" id="modifyFrm">
				<input type="hidden" id="modifyId" name="n_id">
			</form>
			<div style="text-align: right; margin-top: 10px">
			<form action="http://211.63.89.133/prj_tryJobCatch/notice_delete.do" method="post" id="deleteFrm">
