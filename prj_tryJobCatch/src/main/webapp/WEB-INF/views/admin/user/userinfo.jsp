...
%> --%>
  ...
  <div class="row mb-3">
    ...
    <form action="http://211.63.89.133/prj_tryJobCatch/withdraw.do" method="post" id="frm">
    	<input type="hidden" id="deleteId" name="m_id">
    </form>
    <form action="http://211.63.89.133/prj_tryJobCatch/modify.do" method="post" id="modify_frm">
