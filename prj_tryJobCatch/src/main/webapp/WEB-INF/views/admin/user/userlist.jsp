	    ...
	    <a href="http://211.63.89.133/prj_tryJobCatch/dashboard.do">
	      ...
	      <nav class="mt-2">
	        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
	          ...
	          <li class="nav-item">
	          <a href="http://211.63.89.133/prj_tryJobCatch/userlist.do" class="nav-link active">
...
<form action="http://211.63.89.133/prj_tryJobCatch/userinfo.do" method="post" id="hidFrm">
...
%> --%>
 		  ...
 		  <tr onclick="userInfo('${ userList.m_id }')">
            ...
            <td id="id"><c:out value="${ userList.m_id }"/></td>
            <td><c:out value="${userList.m_name}"/></td>
            <td><c:out value="${userList.m_registration_date }"/></td>
            <td><c:out value="${userList.m_join_condition eq 'N' ? '탈퇴':'가입'}"/></td> 
          </tr>
          </c:forEach>
<%--  		  <c:forEach var="userList" items="${userList}" varStatus="i" >
 		  <tr>
            <td><c:out value="${i.index+1}"/></td>
            <td id="id"><a href="#void" onclick="userInfo('${ userList.m_id }')"><c:out value="${ userList.m_id }"/></a></td>
            <td><c:out value="${userList.m_name}"/></td>
            <td><c:out value="${userList.m_registration_date }"/></td>
            <td><c:out value="${userList.m_join_condition eq 'N' ? '탈퇴':'가입'}"/></td> 
          </tr>
