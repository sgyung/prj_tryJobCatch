	          ...
	          <a href="userlist.do" class="nav-link">
	           ...
	           <li class="nav-item menu">
	            ...
	            <ul class="nav nav-treeview">
	              ...
	              <li class="nav-item">
	                <a href="recruitmentlist.do" class="nav-link active">
	                  <i class="far fa-circle nav-icon"></i>
	                  <p>채용 공고</p>
	                </a>
	              </li>
...
<%-- 		<c:forEach var="userList" items="${ userList }" varStatus="i" >
 		  ...
 		  <tr onclick="location.href='recruitmentinfo.do'">
            <td>1</td>
            <td>신세계아이앤씨</td>
            <td><a>신세계아이앤씨 SW개발/운영, 기획, 클라우드,AI...</a></td>
            <td>2023-11-11</td>
            <td>2023-11-15</td>
          </tr>
 		  <tr>
 		  ...
 		  <tr>
            <td>3</td>
            <td>에프엠에셋</td>
            <td><a>에프엠에셋 4분기 신입 Financial Consultant채용</a></td>
            <td>2023-11-11</td>
            <td>2023-11-15</td>
          </tr>
 		  <tr>
            <td>4</td>
            <td>딥브레인AI</td>
            <td><a>[딥브레인AI]  IT 시스템 엔지니어 채용</a></td>
            <td>2023-11-11</td>
            <td>2023-11-15</td>
          </tr>
 		  <tr>
