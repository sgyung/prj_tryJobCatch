	  ...
	  <aside class="main-sidebar sidebar-dark-primary elevation-4">
	          ...
	          <a href="http://211.63.89.133/prj_tryJobCatch/userlist.do" class="nav-link">
	           ...
	           <li class="nav-item menu">
	            ...
	            <ul class="nav nav-treeview">
	              ...
	              <li class="nav-item">
	                <a href="http://211.63.89.133/prj_tryJobCatch/reviewlist.do" class="nav-link active">
	                  <i class="far fa-circle nav-icon"></i>
	                  <p>리뷰 현황</p>
	                </a>
	              </li>
		...
		<div class="content-wrapper">
            ...
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">리뷰 현황</li>
            </ol>
          </div><!-- /.col -->
						<!-- /.col -->
					</div>
                ...
                <table class="table table-bordered table-hover">
                  <thead>
                    <tr>
                      ...
                      <th>기업명</th>
                      <th style="width: 450px">분류</th>
                      <th style="width: 100px">리뷰 수</th>
                    </tr>
                  </thead>
                  <tbody>
<%-- <% 
...
<%-- 		<c:forEach var="userList" items="${ userList }" varStatus="i" >
 		  ...
 		  <tr onclick="location.href='reviewinfo.do'">
            <td>1</td>
            <td><a>현대자동차</a></td>
            <td>정비·A/S·카센터</td>
            <td>15</td>
