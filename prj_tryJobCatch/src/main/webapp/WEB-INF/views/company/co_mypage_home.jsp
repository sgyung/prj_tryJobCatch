...
<script src="/NET/bundles/backbone?v=v0-3Qm9SB2AUlk_aeK9GniBVmVTE9yxsGpDYtXZWlYU1"></script><div id="criteo-tags-div" style="display: none;"></div><div id="criteo-tags-div" style="display: none;"></div><div id="criteo-tags-div" style="display: none;"></div>
...
<div class="tplLyWrap skill-info-popup design devDeleteDesignJob" style="display:none;">
    <div class="modal-inner">
        ...
        <div class="lyCnt">
            ...
            <div class="buttons">
                <a href="/User/Resume/Edit?RNo=25332716" class="btn"><img src="https://i.jobkorea.kr/content/images/user/pop/resume_write_btn.png" alt="이력서 수정하기"></a>
            </div>
        </div>
        <div class="lyBtn">
            <div class="option">
                <input type="checkbox" name="chk_today" id="chk_today" class="blind">
	...
	<div id="wrap">
		<section id="container" style="margin-bottom:203px">
        ...
        <div class="my-info-wrap">
            <div class="my-status-wrap">
                ...
                <div class="user-status-title">
                        <h1><c:out value="${ coProfile.CM_CO_NAME }" /></h1>
...
<input type="hidden" id="DefaultResumeRNo">
<input type="hidden" id="MemSysNo" value="13972865">
<input type="hidden" id="PopUpDeleteDesignJob" value="0">


<meta property="og:MICT_title" content="나의 경쟁력을 어필할 강점을 알고 싶다면?">
<meta property="og:MICT_description" content="장용석 님의 결과를 확인하고 테스트에 참여해 보세요.">
...
<input type="hidden" name="userName" id="userName" value="장용석">
...
<section class="secLnb">
    ...
    <div class="lnbGroup">
        <h2 class="lnbTit"><a href="/User/MyPage" onclick="GA_Event('마이페이지_PC', '사이드메뉴', '개인회원 홈')">기업정보 홈</a></h2>
    </div>
    <div class="lnbGroup">
        <h2 class="lnbTit">채용 관리</h2>
        <ul>
            <li><a href="/User/Resume/Write" target="_blank" onclick="GA_Event('마이페이지_PC', '사이드메뉴', '이력서 등록')">채용 등록</a></li>
            <li>
                <a href="/User/ResumeMng" onclick="GA_Event('마이페이지_PC', '사이드메뉴', '이력서 현황')">채용 현황</a>
            </li>
...
<iframe height="0" width="0" title="Criteo DIS iframe" style="display: none;"></iframe><iframe height="0" width="0" title="Criteo DIS iframe" style="display: none;"></iframe>
