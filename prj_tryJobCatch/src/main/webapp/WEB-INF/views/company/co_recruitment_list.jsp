...
">
    ...
    display: block;
    margin: 0px;
"><a href="#void" target="_blank">${item.r_START_DATE} ~ ${item.r_END_DATE }</a></div>
...
">
    ...
    margin: 0px;
    text-align: center;
"><a href="/User/Resume/Write" target="_blank">채용중</a></div>
...
<a href="#void" target="_blank">${ not empty item.applycnt? item.applycnt : 0 }</a></div>
                                        ...
                                        <div class="col col05" style="width: 20%;">
                                            ...
                                            <div class="btnCell"><button class="btn" type="button"><span>삭제</span></button></div> 
                                        </div>
