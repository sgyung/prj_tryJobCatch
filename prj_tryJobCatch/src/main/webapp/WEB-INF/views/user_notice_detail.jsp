...
<link rel="SHORTCUT ICON" href="/favicon.ico?202312121401">
    ...
    <link rel="canonical" href="https://www.jobkorea.co.kr/help/notice/view?no=14351">
    <link rel="alternate" href="https://m.jobkorea.co.kr/help/notice/view?no=14351" media="only screen and (max-width: 640px)">
    <link rel="alternate" href="ios-app://569092652/https/m.jobkorea.co.kr/help/notice/view?no=14351">
    <link rel="alternate" href="android-app://com.jobkorea.app/https/m.jobkorea.co.kr/help/notice/view?no=14351">
...
<body id="secHelp" class="helpMain" cz-shortcut-listen="true" style="">
...
<script src="/Scripts/Corp/Lounge/Notice.js?20170811"></script>
    ...
    <div class="lnbGroup">
...
</section>    <div class="loungeContent noticeViewContent">
        ...
        <div class="noticeViewWrap">
            <p class="noticeTit">
                ...
                <span class="tit"><c:out value="${ requestScope.n_title }"/></span>
                <span class="date"><c:out value="${ requestScope.n_date }"/></span>
            </p>
            <div class="noticeView">
                <!--// 공지사항 내용 -->
                        <p><c:out value="${ requestScope.n_content }"/></p>

                <!-- 공지사항 내용 //-->
            </div>
            <div class="listBtmArea">
                <div class="btnListExDn">
                   <a href="javascript:void(0)" onclick="history.back()" class="btnMtcTpl">이전</a>
                </div>
